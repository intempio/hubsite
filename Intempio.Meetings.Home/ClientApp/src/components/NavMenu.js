    ...
    async getSettings() {
        ...
        const finalresult = await response.json().then(async (resonse) => {
            ...
            if (item && item.value[0].fields.Menus) {
                ...
                if (token) {
                    this.setState({ firstName: token.firstName, lastName: token.lastName });
                }
                                  ...
                                  case "people":
                                      return <a href="#" class="menu-item">
                                          <div class="menu-item-wrapper">
                                              ...
                                              <span class="menu-button">People</span>
                                          </div>
                                      </a>
                                  case "favorites":
                                      return <a href="#" class="menu-item">
                                  ...
                                  case "social":
                                      return <a href="#" class="menu-item">
                                          <div class="menu-item-wrapper">
                                              ...
                                              <span class="menu-button">Social</span>
                                          </div>
                                      </a>
                                  ...
                                  case "logout":
                                      return <a href="/logout" class="menu-item">
                                          <div class="menu-item-wrapper">
                                              ...
                                              <span class="menu-button">Logout</span>
                                          </div>
                                      </a>
                                  ...
                                  case "upload":
                                      return <a href="/file"  class="menu-item">
                                          <div class="menu-item-wrapper">
                                              ...
                                              <span class="menu-button">Upload a video</span>
                                          </div>
