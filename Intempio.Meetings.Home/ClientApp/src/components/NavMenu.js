    ...
    render() {
        return (
            <>
                ...
                {this.state.loading ? <nav id="skelleton-navbar" class="skelleton-nav">
                    <div id="skelleton-nav-skelleton-header" class="skelleton-nav-skelleton-header">
                        <div class="skelleton-loading skel-con">
                        </div>
                    </div>
                    <div id="skelleton-menu-title" class="skelleton-loading menu-title"></div>
                    <div class="skelleton-menu">
                        <a href="#" class="skelleton-menu-item">
                            <div class="skelleton-menu-item-skelleton-wrapper">
                                <div class="skelleton-loading skel-con"></div>
                                <span class="skelleton-loading menu-button">Home</span>
                            </div>
                        </a>
                        <a href="#" id="resources-desktop" class="skelleton-menu-item">
                            <div class="skelleton-menu-item-skelleton-wrapper">
                                <div class="skelleton-loading skel-con"></div>
                    ...
                    <div class="skelleton-overlay-menu">
                        <div id="skelleton-messagesMobile" class="msgs">
                            <div class="skelleton-msgs-number">
                            </div>
                            <div class="skelleton-loading msgs-svg"></div>
                        </div>
                        <div class="skelleton-vertical-line"></div>
