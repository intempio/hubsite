...
//import './NavMenu.css';
import { IntempioIcons } from './Icons';
...
export class NavMenu extends Component {
    ...
    constructor(props) {
        ...
        super(props);
        this.state = {
            firstName: '', lastName: '', email: props.email, loading: false, menus: [], subMenu: false, submenus: [], colour: '#FFFFFF', menufolder: 'menu', SiteIcon: '0'
        };
    ...
    async getSettings() {
        ...
        const finalresult = await response.json().then(async (resonse) => {
            ...
            if (item && item.value[0].fields.Menus) {
                ...
                resourcesButtonDesktop.addEventListener('click', (e) => {
        ...
        const finalresult = await response.json().then(async (resonse) => {
            ...
            if (item) {
                ...
                if (item && item.intempioSettings.menus) {
                    ...
                    this.setState({ menus: item.intempioSettings.menus.split(","), colour: item.intempioSettings.colour, menufolder: item.intempioSettings.menuFolder, SiteIcon: item.intempioSettings.siteIcon });
                    let token = localStorage.getItem('userToken')
                    token = JSON.parse(token);
                    if (token) {
        ...
        return (
            <>
                ...
                <nav class="skelleton-nav" style={{ display: this.state.loading ? "" : "none" }} >
                    ...
                    <div id="menu-title" class="skelleton-loading menu-title"></div>
                    <div class="menu">
                        <a href="#" class="skelleton-menu-item">
                            <div class="menu-item-skelleton-wrapper">
                                <div class="skelleton-loading skel-con"></div>
                                <span class="skelleton-loading menu-button">Home</span>
                            </div>
                        </a>
                        <a href="#" class="skelleton-menu-item">
                            <div class="menu-item-skelleton-wrapper">
                                <div class="skelleton-loading skel-con"></div>
                                <span class="skelleton-loading menu-button">Resources</span>
                            </div>
                        </a>
                        <a href="#" class="skelleton-menu-item">
                            <div class="menu-item-skelleton-wrapper">
                                <div class="skelleton-loading skel-con"></div>
                                <span class="skelleton-loading menu-button">People</span>
                            </div>
                        </a>
                        <a href="#" class="skelleton-menu-item">
                            <div class="menu-item-skelleton-wrapper">
                    ...
                    <div class="skelleton-overlay-menu">
                        <div class="msgs">
                            <div class="skelleton-msgs-number">
                            </div>
                            <div class="skelleton-loading skelleton-msgs-svg"></div>
                        </div>
                        <div class="vertical-line"></div>
                        <div class="skelleton-menu"></div>
                    </div>

                </nav>
                <nav id="navbar" style={{ display: !this.state.loading ? "" : "none" }} >
                    <div id="nav-header" class="nav-header">
                        {
                            this.state.SiteIcon == '0' ? < svg id="logo" width="110" height="60" viewBox="0 0 110 60" fill="none" xmlns="http://www.w3.org/2000/svg"
