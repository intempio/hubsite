...
export default class RankContent extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { msgs: [], loading: true, msg: '', name: '', inReview: false, file: null, yammer: null, videourl: '#', slideIndex: 1, panelIndex:1 };
    }
    ...
    collapsAll = () => {
        ...
        for (var i = 0; i < coll.length; i++) {
            coll[i].addEventListener("click", function () {
                ...
                var contentid = content.id.split('_')[1]
                self.setState({ panelIndex: parseInt( contentid )})
                //self.sliderConfig(parseInt(contentid), self);
    ...
    sliderConfig(i,self) {
        ...
        switch (i) {
            ...
            case 1:
                self.showSlides(this.state.slideIndex, 1);
            case 2:
                self.showSlides(this.state.slideIndex, 2);
            case 3:
                self.showSlides(this.state.slideIndex, 3);
            case 4:
                self.showSlides(this.state.slideIndex, 4);
            case 5:
                self.showSlides(this.state.slideIndex, 5);
        }
    ...
    muteButton = () => {
        ...
        var mutebtns = document.getElementsByClassName("vjs-mute-control");
        for (var a = 0; a < mutebtns.length; a++) {
            mutebtns[a].addEventListener("click", function () {

                var muteStatus = this.ariaLabel;
                ...
                <div id={this.props.category} class="sessions" style={{ display: !this.state.loading ? "" : "none" }}>
                    ...
                    <div class="sessions-wrapper">
                        <div>
                            ...
                            <div class="content" style={{ display: "none" }} id="c_1">
                        ...
                        <div>
                            <div>
                                ...
                                <div class="content" style={{ display: "none" }} id="c_2">
                        ...
                        <div>
                            ...
                            <div class="content" style={{ display: "none" }} id="c_3">
                        ...
                        <div>
                            ...
                            <div class="content" style={{ display: "none" }} id="c_4">
                        ...
                        <div>
                            ...
                            <div class="content" style={{ display: "none" }} id="c_5">
