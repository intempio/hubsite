        ...
        <div id="chat" class="chat hide">
            ...
            <div class="chat-footer" >
                ...
                <div class="chat-footer-wrapper">
                    ...
                    <form>
                        <label for="messageText"><input id="messageText" type="text" placeholder="Aa" onChange={e => setInput({ "msg": e.target.value , "user": fname + ' ' + lname })} value={input.msg} /></label>
