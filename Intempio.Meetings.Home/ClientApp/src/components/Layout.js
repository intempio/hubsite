        ...
        return (
            <>
                ...
                <header>
                    <div id="messages" class="msgs">
                        ...
                        <svg width="24" height="22" viewBox="0 0 24 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path id="messages-icon" fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                fill={this.state.unseenmsgCount > 0 ? "#ffe5e5" : "#D9D9D9"} />
                        </svg>
                    </div>
                    ...
                    {this.state.generalMsgKey != '' && <ChatContent openChat={this.state.openchat} chatKey={this.state.generalMsgKey} publishKey={this.state.publishKey} subscribeKey={this.state.subscribeKey} chatName={this.state.chatName } />}
