                                ...
                                return (
                                    ...
                                    <div class="presenter"  >
                                        ...
                                        {item.fields.ProfileTitle && <div class="socials">
                                            ...
                                            {item.fields.fb && <a onClick={() => this.openInNewTab(item.fields.fb)}>
                                            ...
                                            {
                                                item.fields.twitter && <a class="twitter"  onClick={() => this.openInNewTab(item.fields.twitter)}>
                                            ...
                                            {item.fields.linkedin && <a  onClick={() => this.openInNewTab(item.fields.linkedin)}>
